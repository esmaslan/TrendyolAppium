...
public class ElementHelper {
    ...
    public void pressEnter2(By locate) {
    ...
    public void scrollDownWithElement(By locate) {
        int startX = driver.findElement(locate).getSize().getWidth()/ 2 ;
        int startY = driver.findElement(locate).getSize().getHeight()/ 2 ;
        int endx = driver.findElement(locate).getSize().getWidth()/ 2 ;
        int endY = (int) (driver.findElement(locate).getSize().getHeight()* 0.2 );
