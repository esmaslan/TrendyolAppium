    ...
    public static WebDriver createDriver(String browser, String url, int implictyWait) {
        ...
        switch (browser) {
            ...
            case "android":
             ...
             //   capabilities.setCapability(CapabilityType.PLATFORM_NAME,"");// sektörde bu ikisi kullanılıyor
             // capabilities.setCapability(MobileCapabilityType.PLATFORM_NAME,"");// sektörde bu ikisi kullanılıyor
                try {
